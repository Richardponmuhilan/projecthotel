      ...
      <div className="about-overlay">
        <div className="container my-5">
          <div className="row flex-column-reverse flex-lg-row align-items-center">
            ...
            {/* text */}
            <motion.div className="col-lg-6 d-flex flex-column justify-content-center aboutus-text"
              ...
              <h2 className="headline mb-4 mb-lg-5">
                ...
                <span className="white">. Exquite</span>
              </h2>
          ...
          <div className="features-section container my-5">
            <div className="row justify-content-center">
              <div className="col-lg-10">
                <motion.div variants={containerVariants} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }}>
                  <Slider {...sliderSettings}>
                    <motion.div className="feature-card text-center" variants={cardVariant}>
                      <img src={card1} alt="" className="card-bg-img" />
                      <h3 className="feature-title">Authentic Indian Cuisine</h3>
                      <p className="feature-desc">From spicy curries to fragrant biryanis — experience the rich, diverse flavors of India.</p>
                    </motion.div>

                    <motion.div className="feature-card text-center" variants={cardVariant}>
                      <img src={card2} alt="" className="card-bg-img" />
                      <h3 className="feature-title">Refreshing Sips: Coffee & Mocktails</h3>
                      <p className="feature-desc">Start your day or refresh your evening with our premium Indian-style coffee and chilled mocktails.</p>
                    </motion.div>

                    <motion.div className="feature-card text-center" variants={cardVariant}>
                      <img src={card3} alt="" className="card-bg-img" />
                      <h3 className="feature-title">Fine Drinks & Cocktails</h3>
                      <p className="feature-desc">Enjoy your meal with a curated selection of alcoholic beverages, classic cocktails and premium spirits.</p>
                    </motion.div>

                    <motion.div className="feature-card text-center" variants={cardVariant}>
                      <img src={card5} alt="" className="card-bg-img" />
                      <h3 className="feature-title">Royal Indian Curries</h3>
                      <p className="feature-desc">Experience the richness of India made using traditional recipes.</p>
                    </motion.div>

                    <motion.div className="feature-card text-center" variants={cardVariant}>
                      <img src={card4} alt="" className="card-bg-img" />
                      <h3 className="feature-title">Authentic Biryani</h3>
                      <p className="feature-desc">Indulge in fragrant basmati rice, aromatic spices, and tender meat.</p>
                    </motion.div>

                    <motion.div className="feature-card text-center" variants={cardVariant}>
                      <img src={card6} alt="" className="card-bg-img" />
                      <h3 className="feature-title">Tandoori Delights</h3>
                      <p className="feature-desc">Enjoy smoky tandoor-grilled meats, and breads, cooked to perfection.</p>
                    </motion.div>
                  </Slider>
                </motion.div>
...
{/* ---------- Booking section (replace existing booking block) ---------- */}
{/* ---------- Booking section (replace existing booking block) ---------- */}
